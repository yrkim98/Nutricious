...
class Filter extends Component {
    ...
    retrieveLocal(event) {
        this.props.setDisplay(
            "local", !this.props.display.local
        )
    }
    retrieveState(event) {
        this.props.setDisplay(
            "state", !this.props.display.state
        )
    }
    retrieveCounty(event) {
        this.props.setDisplay(
            "county", !this.props.display.county
        )
    }
    retrieveFederal(event) {
        this.props.setDisplay(
            "federal", !this.props.display.federal
        )
    }
    render() {
        return (
                ...
                <Row>
                    <Col>
                        <InputGroupAddon addonType="append">
                            ...
                            <InputGroupText>
                                <Input role="button" aria-pressed="false" addon onClick={this.retrieveLocal.bind(this)} type="checkbox" aria-label="Local Checkbox" />
                            </InputGroupText>
                        </InputGroupAddon>
                    </Col>
                    <Col>
                        <InputGroupAddon addonType="append">
                            ...
                            <InputGroupText>
                                <Input role="button" aria-pressed="false" addon onClick={this.retrieveCounty.bind(this)} type="checkbox" aria-label="Local Checkbox" />
                            </InputGroupText>
                        </InputGroupAddon>
                    </Col>
                    <Col>
                        <InputGroupAddon addonType="append">
                            ...
                            <InputGroupText>
                                <Input role="button" aria-pressed="false" addon onClick={this.retrieveState.bind(this)} type="checkbox" aria-label="State Checkbox" />
                            </InputGroupText>
                        </InputGroupAddon>
                    </Col>
                    <Col>
                        <InputGroupAddon addonType="append">
                            ...
                            <InputGroupText>
                                <Input role="button" aria-pressed="false" addon onClick={this.retrieveFederal.bind(this)} type="checkbox" aria-label="Federal Checkbox" />
                            </InputGroupText>
                        </InputGroupAddon>
                    </Col>
                </Row>
